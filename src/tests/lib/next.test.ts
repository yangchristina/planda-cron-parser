...
test('chris tries to test #1', () => {
    const crons: { cron: string; should: string[] }[] = [
        {
            cron: "0 7 ? * MON,WED,FRI * 3600000",
            should: [
...
//     const crons: { cron: string; should: string[] }[] = [
//         {
//             cron: '23,24,25 17,18 25 MAR/4 ? 2020,2021,2023,2028 3600000',
//             should: [
...
//     const crons: { cron: string; should: string[] }[] = [
//         {
//             cron: '10 7/5 7 * ? 2020,2021 3600000',
//             should: [
...
//     const crons: { cron: string; should: string[] }[] = [
//         {
//             cron: '0-29/5 22 09 05 ? 2020,2021,2022 3600000',
//             should: [
